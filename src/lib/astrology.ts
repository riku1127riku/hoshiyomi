...
const ZODIAC_POOL: Record<ZodiacKey, {
  ...
  aries: {
    ...
    loveStyles: [
      '情熱の炎で恋を燃やす、直感で動くタイプです。',
      '一目惚れが多く、好きになったら全力で突き進みます。',
      '積極的な愛の表現が自然にできる、エネルギッシュな恋愛をします。',
      '恋に落ちると猪突猛進。真剣な思いを真っ直ぐに届けます。',
      '情熱のままに動く。その純粋さと勢いが相手の心を動かします。',
      '好きになると独占欲も出る。それが本気のサインです。',
      '行動の早さと熱量が、自然と関係を深めていきます。',
    ],
  ...
  taurus: {
    ...
    loveStyles: [
      ...
      '安心感と信頼を積み重ねる恋愛をします。',
      '誠実で粘り強い。動き出したら本気の証拠です。',
      '愛は言葉より行動で示す。小さな積み重ねが本気の証です。',
      'じっくり深みにはまる恋愛。一度決めたら揺るがない一途さが魅力です。',
      '五感を大切にするロマンチスト。ムードを大切にする相手と合います。',
      '慎重に見えて内心は燃えている。信頼を得たら一気に距離が縮まります。',
    ],
  ...
  gemini: {
    ...
    loveStyles: [
      '会話が弾む相手に惹かれる。知的な刺激が恋心のスイッチを入れます。',
      '好奇心旺盛で多彩な出会いがある。同じ話題で盛り上がれる人が運命の相手です。',
      'フレンドリーで距離感が上手い。気づいたら友達から恋人になっているタイプです。',
      '恋は頭と心で同時に感じる。知的なときめきが愛情の入口です。',
      '言葉が上手く、気持ちを伝えるのが得意。コミュニケーションで絆を深めます。',
      '多彩な面を持つから、一緒にいて飽きない。新鮮さをキープできる相手が理想です。',
      '友情から発展する恋も多い。気づいたら友達以上になっているパターンが典型です。',
    ],
  ...
  cancer: {
    ...
    loveStyles: [
      '包み込む愛情で相手を癒す。「この人といると落ち着く」と言われやすいです。',
      '感受性が豊かで共感力が高い。相手の気持ちを敏感に察知して寄り添えます。',
      '家庭的な温かさが魅力。守られたい気持ちと守りたい気持ちが共存しています。',
      '愛情深く、相手の変化を敏感に察知する。細かい気づかいが自然とできます。',
      '保護本能が強く、大切な人を守ろうとする。その温かさが相手の心を解かします。',
      '感情の波はあるけれど、愛した人への想いは揺るがない一途さがあります。',
      '安心できる関係をなによりも大切にする。信頼が愛情の土台です。',
    ],
  ...
  leo: {
    ...
    loveStyles: [
      '特別扱いされることを大切にする。愛情表現は大胆で惜しみないタイプです。',
      '自分も相手も輝かせる恋愛が好き。一緒にいると自信が湧いてくるカップルです。',
      '堂々としていて存在感がある。惹きつけるオーラで自然と縁が集まります。',
      '愛する人を太陽のように照らす。一緒にいると相手も輝き出します。',
      '大切にされることへの感度が高い。愛情表現はわかりやすく伝えてほしいタイプです。',
      '惚れると一直線。大胆でドラマチックな愛の伝え方をします。',
      '自分も相手も誇れる関係が理想。一緒にいて誇らしい存在を求めます。',
    ],
  ...
  virgo: {
    ...
    loveStyles: [
      '細やかな気配りで愛情を示す。見えないところでそっと支えるのが得意です。',
      '慎重に相手を見極めてから動く。一度信頼した相手には献身的に尽くします。',
      '完璧主義だけど、大切な人の前では素直になれる。そのギャップが魅力です。',
      '見えないところで尽くす愛情。相手が気づかない努力が愛の本質です。',
      '言葉より行動で示す派。気づいてもらえなくても黙って続ける誠実さがあります。',
      '批評眼があるからこそ、本物と認めた相手への愛は深く揺るがないです。',
      '素直に気持ちを伝えるのは苦手だけど、行動を見れば全部わかるタイプです。',
    ],
  ...
  libra: {
    ...
    loveStyles: [
      'ロマンチックな演出が好き。美しい関係を大切に育てていきます。',
      '調和を愛するパートナー。喧嘩より話し合いで解決するタイプです。',
      'おしゃれなデートや特別な時間を共有することで絆が深まります。',
      '美しい恋愛を追い求める。雰囲気と演出でときめきを大切にします。',
      '相手に合わせる柔軟さがある。穏やかな関係の中に深い愛情があります。',
      '決断は遅くても、一度決めた愛は本物。迷った末の気持ちは揺るがないです。',
      'おしゃれな場所や特別な体験が愛を育てる。センスの合う相手と深まりやすいです。',
    ],
  ...
  scorpio: {
    ...
    loveStyles: [
      '深く狂おしいほどの愛。一度心を開いた相手には全力で尽くします。',
      '直感で相手の本質を見抜く。魂レベルで繋がりたいと感じるタイプです。',
      '情熱と洞察力が共存する。秘密めいた雰囲気が相手を惹きつけます。',
      '表面は穏やかでも、内側に溶岩のような情熱を秘めています。',
      '一度好きになると感情が止まらない。それほど深く人を愛せるのが強みです。',
      '勘が鋭く嘘を見抜く。正直な相手にだけ心を開く、信頼を重んじます。',
      '独占欲と守護本能が強い。大切にしている人には絶対的に味方になります。',
    ],
  ...
  sagittarius: {
    ...
    loveStyles: [
      '自由を愛しながら一緒に成長できる恋愛を求める。冒険を共にしたいです。',
      '明るくオープンで友達が多い。共通の夢を持つ相手と運命を感じやすいです。',
      '束縛が苦手だけど、信頼できる相手には深く絆を結びます。',
      '心が自由でいられる相手と深く繋がる。束縛より信頼を選ぶ関係が理想です。',
      '冒険とロマンを求める恋愛体質。一緒に新しい世界を見たいタイプです。',
      '友達感覚から始まる恋が多い。自然体で一緒にいられる人が一番です。',
      '愛情はオープンに表現する。正直な気持ちの伝え方が信頼を生みます。',
    ],
  ...
  capricorn: {
    ...
    loveStyles: [
      '責任感と誠実さで愛を育てる。時間をかけて信頼を積み重ねるタイプです。',
      '外では冷静でも、心を許した相手には意外と甘えん坊な一面があります。',
      '現実的だけど夢を持っている。将来を見据えた真剣な恋愛が好きです。',
      '誠実さと責任感が愛情の形。言葉より行動で愛を証明します。',
      '長期的な目線で関係を育てる。焦らず確実に、信頼を積み上げていきます。',
      '仕事と恋愛を両立させる力がある。本気になった相手への献身は格別です。',
      '外見は堅物でも、愛した人の前では意外なほど素直になれます。',
    ],
  ...
  aquarius: {
    ...
    loveStyles: [
      '友達から始まる恋が多い。独自のペースで深まる唯一無二の関係を大切にします。',
      'ユニークな価値観を持つ相手に惹かれる。特別な絆を求めるタイプです。',
      '自立していて個性的。相手の自由も自分の自由も大切にするパートナーです。',
      '普通の恋愛に収まらない独自の関係性を築く。唯一無二の縁を大切にします。',
      '相手の個性を尊重できる。自由を与え合える関係が長続きする秘訣です。',
      '感情より理屈で考えるが、一度ハートに火がつくと意外と熱いタイプです。',
      '友情と愛情の境界が曖昧。気づいたら特別な存在になっているケースが多いです。',
    ],
  ...
  pisces: {
    ...
    loveStyles: [
      '夢見がちで純粋な愛。相手に溶け合うような深い繋がりを求めます。',
      '共感力と想像力で相手の心を読む。感情で繋がることが恋愛の核心です。',
      'ロマンチックな雰囲気と繊細な気遣いで相手を包み込む恋愛をします。',
      '愛されることで才能が開花する。大切にしてくれる相手のそばで輝きます。',
      '感情の波に乗りながら愛する。感受性の豊かさが恋愛を深くします。',
      '直感で相手の本質を掴む。言語化できない縁のようなものを感じるタイプです。',
      '純粋さと優しさが武器。その素直な愛情表現が相手の心を溶かします。',
    ],
...
// zodiacLoveStyle 3部構成グローバルプール
// B: 11テキスト（互いに素）、C: 13テキスト（互いに素）→ zodiac A(7) × B(11) × C(13) = LCM=1001日

const LOVE_STYLE_B: string[] = [
  '大切な人への誠実な気持ちが、縁を深める力になります。',
  '心が動いた瞬間を逃さないで。それが本物の縁のサインです。',
  '焦らず自分らしくいることが、最大の引き寄せになります。',
  '相手への小さな気づかいが、愛情をリアルに伝えます。',
  '直感を信じて動くことで、縁は引き寄せられてきます。',
  '素直でいることが、あなたの恋愛を進める力です。',
  '愛は丁寧に育てるほど、深く輝いていきます。',
  '相手を尊重する心が、関係をより豊かにします。',
  '言葉より行動で、気持ちを伝えていきましょう。',
  '思いやりを持って接することで、絆は確実に深まります。',
  '自分を磨くことが、最大の恋愛準備になります。',
]

const LOVE_STYLE_C: string[] = [
  '今日は少しだけ心をオープンにしてみて。',
  '笑顔でいると、良い縁が自然と集まります。',
  '気になる人への勇気ある一歩が、今日の吉です。',
  '大切な人への感謝を言葉にしてみましょう。',
  '直感を信じて行動すると、今日は流れに乗れます。',
  '素直な気持ちを伝えると、何かが動き出します。',
  '自分らしく輝く今日が、縁を引き寄せます。',
  '心の声を大切に。その選択が縁を変えます。',
  '今日のあなたには特別な輝きがあります。',
  '縁は動いています。流れを信じて前に進んで。',
  '今日の真心は、必ず相手に届きます。',
  '愛情を惜しまず伝えるチャンスの日です。',
  '今日の一歩が、素晴らしい縁の始まりになります。',
]
...
export function calcAstrologyResult(birthDate: string, today: Date = new Date()): AstrologyResult {
  ...
  // 生年月日ハッシュ → ユーザーごとにサイクルをずらす
  const bdHash = birthDate.replace(/-/g, '').split('').reduce((acc, c, i) => acc + parseInt(c) * (i + 1), 0)
  const pSeed = seed + (bdHash % 997)  // 997は素数、大きくずらす
  ...
  return {
    ...
    // 3部構成: zodiacA(7) × B(11) × C(13) → LCM=1001日（2.7年）同じ組み合わせにならない
    zodiacLoveStyle: pick(zodiac.loveStyles, pSeed) + pick(LOVE_STYLE_B, pSeed) + pick(LOVE_STYLE_C, pSeed),
